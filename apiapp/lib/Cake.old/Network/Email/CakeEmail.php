 ...
 */
	public function send($content = null) {
		...
		# inject the mail_message_id and if a tracker is set, update it
		$this->mail_message_id = $this->transportClass()->mail_message_id;
        if(isset($this->viewVars()['tracker']) && !empty($this->mail_message_id)) {
            $Tracker = ClassRegistry::init('Tracker');
            $Tracker->id = $this->viewVars()['tracker']['Tracker']['id'];
            $Tracker->saveField('mail_message_id', $this->mail_message_id);
        }
        ...
        // if(isset($tracker) && isset($Tracker->id)) {
        //     $Tracker->saveField('mail_message_id', $Email->mail_message_id);
        // }
