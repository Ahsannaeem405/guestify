<nav class="navbar navbar-default navbar-guestify navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <?php if($this->Session->check('Auth.User.id')) { ?>
                <?php if($this->Permission->isClient()) { ?>
                    <a class="navbar-brand" href="/dashboard"><img src="/graphics/logos/150/guestify_logo_word_brand_150.png" alt="guestify" /> </a>
                <?php } elseif($this->Permission->isAdmin()) { ?>
                    <a class="navbar-brand" href="/admin_dashboard"><img src="/graphics/logos/150/guestify_logo_word_brand_150.png" alt="guestify" /> </a>
                <?php } ?>
            <?php } else { ?>
        ...
        <div class="collapse navbar-collapse" id="main-navbar-collapse">
                ...
                <div class="btn-group margin10px pull-right">
                    ...
                    <ul id="user-menu" class="dropdown-menu" role="menu">
                        ...
                        <?php if($this->Permission->isClient()) { ?>
                            ...
                            <li class="<?php echo $first_run_class; ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-star"></span> '.__('My Widgets', true), array('controller' => 'widgets', 'action' => 'index'), array('class' => $first_run_class, 'escape' => false)); ?></li>
                            <li class="divider"></li>
            ...
            <?php /* DISABLED LANGUAGE SELECTOR 
            ...
            */ ?>
            ...
            <?php if($this->Session->check('Auth.User.id')) { ?>
                        ...
                        <ul class="dropdown-menu" role="menu" style="width: 200px; ">
                            <?php foreach($statistics_list as $host_name => $stat) { ?>
                                ...
                                <?php foreach($stat as $poll_id => $poll_title) { ?>
                                    <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-chevron-right pull-right"></span><strong>'.$poll_title.'</strong>', array('controller' => 'polls', 'action' => 'showLast30', $poll_id), array('class' => '', 'escape' => false)); ?></li>
                                <?php } ?>
                                <li class="divider"></li>
                            <?php } ?>
                        </ul>
                ...
                <?php } ?>
                <?php if($this->Permission->isClient()) { ?>
                    <a href="/dashboard" class="btn btn-primary margin10px pull-right"><span class="glyphicon glyphicon-home"></span></a>
                <?php } elseif($this->Permission->isAdmin()) { ?>
                    <a href="/admin_dashboard" class="btn btn-primary margin10px pull-right"><span class="glyphicon glyphicon-home"></span></a>
                <?php } ?>
            <?php } ?>
