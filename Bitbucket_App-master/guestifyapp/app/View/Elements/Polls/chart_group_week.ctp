...
<div id="chart-week-<?php echo $group_id; ?>" style="height: 400px"></div>

<script type="text/javascript">
    $(document).ready(function() {
        plotGroupChartWeek(<?php echo $group_id; ?>, "<?php echo $year; ?>", "<?php echo $weeknumber; ?>", "<?php echo $max_scale + 0.5; ?>");
    });
</script>
