<div class="clearfix">
    ...
    <h3 class="pull-left"><?php echo $group['Group']['name']; ?></h3>
</div>


<div id="chart-year-<?php echo $group_id; ?>" style="height: 400px"></div>

<script type="text/javascript">
    $(document).ready(function() {
        plotGroupChartYear(<?php echo $group_id; ?>, "<?php echo $year; ?>", "<?php echo $max_scale + 0.5; ?>");
    });
</script>
