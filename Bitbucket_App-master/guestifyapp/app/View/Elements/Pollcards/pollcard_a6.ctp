...
<body>
    <div id="wrapper">
        <div id="content">
                ...
                <tr>
                    ...
                    <td align="right">
                        <?php if(!empty($poll['Host']['logo'])) { ?>
                            <p><?php echo $this->Html->Image(Configure::read('CDN.Host').'hosts/300/'.$poll['Host']['logo'], array('align' => 'right', 'class' => 'host_img','width' => '2.5cm', 'alt' => $poll['Host']['name'])); ?></p>
                        <?php }  ?>
                    </td>
                </tr>
            </table>
            <div class="centered">
                ...
                <div class="qr-code">
                    <table width="100%" style="font-size: 8pt;">
                        <tr>
                            <td valign="top">
                                <?php echo $this->Html->Image('/img/qrcodes/'.$qrcode_300, array('width' => '3cm')); ?>
                            </td>
                            <td valign="top">
                ...
                <strong style="font-size: 9pt;"><?php echo __('How does it work?', true); ?></strong>
            ...
            <div id="footer" style="text-align:center; font-size: 6pt;">
