...
class MigrateShell extends Shell
{
    ...
    */
    ...
    function startup()
    {
        ...
        if (isset($this->args[0]) && ($this->args[0] == 'us')) {
            $this->dataSource = 'us';
            define('MIGRATIONS_PATH', APP_PATH .'config' . DS .'migrations' . DS . 'us');
        } elseif (isset($this->args[0]) && ($this->args[0] == 'at')) {
            $this->dataSource = 'at';
            define('MIGRATIONS_PATH', APP_PATH .'config' . DS .'migrations' . DS . 'at');
        } else {
