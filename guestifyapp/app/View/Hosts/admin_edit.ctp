<?php
    ...
    $this->Html->addCrumb($host['Host']['name'], array('controller' => 'hosts', 'action' => 'adminView', $host['Host']['id']), array('escape' => false));
    $this->Html->addCrumb(__('Edit host', true));
?>

<div class="btn-toolbar pull-right">
    <?php echo $this->Html->link(__('Back', true), array('action' => 'adminView', $host['Host']['id']), array('class' => 'add-poll btn btn-info', 'escape' => false)); ?>
</div>
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <div class="panel panel-info">
                    <div class="panel-body">
                        <strong><span class="glyphicon glyphicon-info-sign"></span> <?php echo __('Help', true);?></strong>
                        <hr />
                        <p>Coming soon!</p>
                    </div>
                </div>
