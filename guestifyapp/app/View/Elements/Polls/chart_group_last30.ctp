<div class="clearfix">
    <div class="pull-right">
        <div id="legend-holder-<?php echo $group_id; ?>" class="clearfix">
            <?php
                $colors = $colors = Configure::read('Colors');
...
<div id="chart-last30-<?php echo $group_id; ?>" style="height: 400px"></div>


<script type="text/javascript">
    $(document).ready(function() {
        plotGroupChartLast30(<?php echo $group_id; ?>, "<?php echo $date; ?>", "<?php echo $max_scale + 0.5; ?>");
    });
</script>
