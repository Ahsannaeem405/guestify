<div id="login">
    <div class="clearfix ">
        <div class="col-xs-12 well">
            <h1 class="hide"><?php echo __('Login', true); ?></h1>
            <?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' => 'login'))); ?>
                ...
                <?php echo $this->Html->link(__('Forgot your password?', true), array('controller' => 'users', 'action' => 'forgotPassword'), array('class' => 'btn btn-link btn-sm btn-block')); ?>
