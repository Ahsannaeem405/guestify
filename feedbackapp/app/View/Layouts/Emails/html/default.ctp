                                    ...
                                    <tr>
                                        <td width="98%" style="padding: 0px;">
                                            <div style="background-color: #059ec7; padding: 0; font-family:  Helvetica, Arial, sans-serif; boder:1px #fff solid; width: 590px; height: 170px; margin: 0px;">
                                                <a href="<?php echo Configure::read('NON_SSL_HOST_PUBLIC'); ?>" style=" color: #eee; text-decoration: none; text-transform: uppercase; text-align: center; display: block;"><img src="<?php echo Configure::read('NON_SSL_HOST'); ?>/graphics/logos/300/guestify_logo_word_brand_regular_300.jpg" alt="guestify.net" width="300px" height"150px" border="0" style="margin: 10px;vertical-align: bottom;"  /></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <div style="display: block;">
                                                    <div style="font-family:  Helvetica, Arial, sans-serif; font-size: 12px; color: #666;">
                                                        <p style="text-align: right;">                                                           
                                                            <a href="https://www.facebook.com/guestifyapp" target="_blank" title="Follow us on Facebook" style="float: left;"><img src="<?php echo Configure::read('NON_SSL_HOST'); ?>/graphics/own-social/48-facebook.png" alt="Facebook: guestifyapp" ></a>&nbsp;
                                                            <a href="https://twitter.com/guestifyapp" target="_blank" title="Follow us on twitter" style="float: left;"><img src="<?php echo Configure::read('NON_SSL_HOST'); ?>/graphics/own-social/48-twitter.png" alt="twitter: @guestifyapp" ></a>
                                                            <small style="font-size: 10px;">
                                                                <?php echo __('Copyright', true); ?> &copy; 2014 - <?php echo date('Y'); ?> <a href="https://guestify.net/en" style="color: #059ec7; text-decoration: none;">https://guestify.net/en</a><br />
