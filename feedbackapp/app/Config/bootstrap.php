...
Configure::write('Email.dev', 'noreply@guestify.net');
...
if(!isset($_SERVER['argv'][3])) {
    if(isset($_SERVER['HTTP_HOST'])) {
        ...
        if (file_exists($filename)) {
            ...
            require_once(APP . 'Config/Bootstrap/guestify');
        }
    } else {
        # no other domains
...
CakeLog::config('error', array(
     ...
     * modified method to use DB tokens instead of PO file
     *
